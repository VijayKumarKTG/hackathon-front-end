...
const Profile = () => {
  ...
  //   ) {
  //     let ids_list_as_number: number[] = Array.isArray(user_questions_ids_data)
  ...
  //   if (user_answers_ids_data && !isUserAnswersLoading && !isUserAnswersError) {
  //     let ids_list_as_number: number[] = Array.isArray(user_answers_ids_data)
